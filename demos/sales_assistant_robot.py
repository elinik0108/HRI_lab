...
def run_scenario(tts, stt, camera, detector, tablet, anim, posture, leds, awareness, dashboard_url, on_robot=False):
    posture.stand()
    camera.start()
    time.sleep(1.0)
    tts.set_volume(75)
    ...
    ## loop to reset after the cutomer is done, goes to next customer.
    while True:
